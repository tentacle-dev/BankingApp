...
const SignUp: React.FC = () => {
  ...
  useEffect(() => {
    setIsDisabled(
      !(email.trim() && password.trim() && phoneno.trim() && checked),
    );
  ...
  return (
    <>
      ...
      <View className="flex-1" style={{ backgroundColor: "#0b2adb" }}>
        <View
          className="bg-white flex-1  rounded-t-3xl p-6 shadow-lg"
          style={{ borderTopLeftRadius: 50, borderTopRightRadius: 50 }}
        >
          <Text className="text-4xl font-bold text-blue-800 pt-4">
            Welcome to us,
          </Text>
          <Text className="pl-1 text-lg mb-3">
          ...
          <View className="flex-row mr-4 items-center mb-5">
            ...
            <Text className="text-gray-800 ml-2 mr-4 text-md">
              ...
              <Text
                ...
                onPress={() => alert("Redirect to Terms & Conditions")}
              >
